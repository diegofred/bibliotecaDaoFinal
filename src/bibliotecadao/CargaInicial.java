...
public class CargaInicial {
    ...
    public static String TipoNovela = "Novela";
    public static String TipoTeatro = "Teatro";
    public static String TipoPoesia = "Poesia";
    public static String TipoEnsayo = "Ensayo";
    ...
    public static void cargarDatosIniciales() {
        ...
        tipoLibroDao.guardarTiposLibros(tp1);

        TipoLibro tp2 = new TipoLibro();
        tp2.setNombre("Teatro");
        tipoLibroDao.guardarTiposLibros(tp2);
