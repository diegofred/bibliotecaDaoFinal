...
//        this.daoMulta = new Dao.EnMemoria.MultaDaoImpEnMemoria();
        ...
        this.lectoresDao = (LectorDao) DaoFactory.obtenerDao(LectorDao.class.getName());
        this.prestamoDao = (PrestamoDao) DaoFactory.obtenerDao(PrestamoDao.class.getName());
        this.daoMulta = (MultaDao) DaoFactory.obtenerDao(MultaDao.class.getName());
    }
    ...
    public void devolverPrestamo(Prestamo prestamo) {
        ...
        Copia c = prestamo.getCopia();
        c.setEstado(Copia.EN_BIBLIOTECA);
        copiaDao.actualizarCopia(prestamo.getCopia());
